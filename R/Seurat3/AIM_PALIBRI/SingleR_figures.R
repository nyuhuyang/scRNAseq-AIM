...
###############################
pred = readRDS("output/20210311_MCL_AIM_74_singleR_pred.rds")
...
singlerDF$cell.types = gsub("DC|Macrophages|Eosinophils|Megakaryocytes|Neutrophils|Monocytes","Myeloid_cells",singlerDF$cell.types)
