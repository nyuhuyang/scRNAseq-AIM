...
if(reference == "MCL+blue_encode"){
    ...
    saveRDS(object = pred, file = "output/MCL_AIM_93_20220519_blue_encode_singleR_pred.rds")
}
...
if(reference == "MCL+azimuth_PBMC"){
    ...
    system.time(pred <- classifySingleR(sce[common,], trained))
    saveRDS(object = pred, file = "output/MCL_AIM_93_20220519_azimuth_PBMC_singleR_pred.rds")
}

saveRDS(object@meta.data, file = "output/MCL_AIM_93_20220519_metadata.rds")